...
public class CoordinateTest {
    ...
    public void test_isEqual_for_SphericCoordinate_and_CartesianCoordinate_returns_true_if_they_describe_the_same_point(){
        ...
        SphericCoordinate coordinate1 = SphericCoordinate.newInstance(23.34, 42, 25);
        CartesianCoordinate coordinate2 = CartesianCoordinate.newInstance(coordinate1.getX(), coordinate1.getY(), coordinate1.getZ());
